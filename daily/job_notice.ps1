...
$objExcel.quit()
 ...
 $obj1=$obj| ConvertTo-Html | Out-String
   ...
   $linkx="<BR><a href=""https://docs.google.com/spreadsheets/d/13IZPkyEXxKIJv_G-ltGLettIpHB9aWRYOwdHB8lrLKk/"">人力列表</a><BR><a href=""https://drive.google.com/drive/folders/1jQ-bW0W0VK78gbiNsAy_PmRbGM4fkep-"">機器借用表單</a>"
 ...
 from = $from
 BodyAsHtml = $True
 Subject = "<$day_today>Drv_Team Job notice (This is auto mail)"
 Body =$body+$obj1
}
